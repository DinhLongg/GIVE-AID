    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NgoPrograms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NgoPrograms_NGOs_NGOId",
                        column: x => x.NGOId,
                        principalTable: "NGOs",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CauseName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Galleries_NgoPrograms_ProgramId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Children Welfare", "Children" },
                    { 2, "Education", "Education" },
                    { 3, "Health Care", "Health" },
                    { 4, "Support Disabled", "Disabled" }
                });
